self: super: {
  throttled = self.stdenv.mkDerivation rec {
    pname = "throttled";
    version = "0.10.0";
    ...
    nativeBuildInputs = [ super.python3Packages.wrapPython ];

    pythonPath = with super.python3Packages; [
      configparser
      dbus-python
      pygobject3
    ];

    propagatedBuildInputs = [ super.pciutils ];
